...
from backend.monolith.models.models import ActiveSession  # Assuming you have Session model defined
from backend.monolith.database.database import get_db  # Your database session dependency
...
async def check_access(
    ...
    try:
        ...
        active_session_instance = get_session_by_token(db, token)
