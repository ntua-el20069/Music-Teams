...
def get_songlist_file_path(
    user_id: Optional[int] = None, team_name: Optional[str] = None
) -> str:
    """
...
def save_songlist_data(
    file_path: str, data: Dict[str, List[Dict[str, Any]]]
) -> Tuple[bool, str]:
    """
...
def get_song_list(
    db: Session, user_id: int, songlist_id: int, team_name: Optional[str] = None
    ...
    try:
        ...
        for song_data in songs_data:
            if (
                ...
                and "id" in song_data
                and "title" in song_data
            ):
                songs.append(
                    SongInListModel(id=song_data["id"], title=song_data["title"])
                )
...
def validate_song_access_for_list(
    db: Session, user_id: int, song_id: int, team_name: Optional[str] = None
) -> Tuple[bool, str]:
    """
